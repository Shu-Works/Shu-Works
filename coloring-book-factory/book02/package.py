...
RAW_DIR = HERE / "raw"
OUT_DIR = HERE / "output"
_local_structure = HERE / "06_Page_Structure.csv"        # prefer book-local CSV
STRUCTURE_CSV = _local_structure if _local_structure.exists() else HERE.parent / "06_Page_Structure.csv"
