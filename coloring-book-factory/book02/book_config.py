#!/usr/bin/env python3
"""
book_config.py — shared configuration for the Book #2 production tools.
...
copy this folder and edit the BOOK block + the local 06/07 CSVs.
"""
...
BOOK = {
    ...
    "volume": "Volume 2",
    "shop": "(Your Shop Name)",
    "cover_source_page": 48,          # "The Library in the Tree"
    "next_volume": "The Witch's Apothecary",
